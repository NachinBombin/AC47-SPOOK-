-- AC-47 Spooky | shared.lua
-- Same model, same sounds as the reference AC-47 repo.
-- Do NOT edit sound/model paths; they point to existing content.

ENT.Type            = "anim"
DEFINE_BASECLASS( "lunasflightschool_basescript" )

ENT.PrintName       = "Douglas AC-47 Spooky"
ENT.Author          = "Bombin / NachinBombin"
...
ENT.MaxPrimaryAmmo   = 9999  -- handled per-weapon internally; LFS still needs a value
ENT.MaxSecondaryAmmo = 0

-- ============================================================
-- SOUNDS  (all paths point to existing AC-47 content)
-- ============================================================
