...
local col_accent        = Color(180, 100, 0,   255)  -- olive/bronze for AC-47 era
...
-- ── Tab & Category ────────────────────────────────────────────
hook.Add("AddToolMenuTabs", "AC47_Tab", function()
    spawnmenu.AddToolTab("Bombin Support", "Bombin Support", "icon16/bomb.png")
end)

hook.Add("AddToolMenuCategories", "AC47_Categories", function()
